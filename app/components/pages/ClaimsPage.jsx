    ...
    <div style={{ paddingTop: 40 }}>
      ...
      {nonRobuxClaims.length === 0 ? (
        <div className="card" style={{ padding: 48, textAlign: "center" }}>
          ...
          <div style={{ fontFamily: "'Fredoka', sans-serif", fontSize: 18, fontWeight: 800, color: "var(--text)", marginBottom: 8 }}>
            No claims yet
          </div>
          <div style={{ fontSize: 14, color: "var(--text3)", fontWeight: 500 }}>
            {loggedIn
              ? "Purchase an item from Withdraw to see claims here"
              : "Sign in and purchase an item from Withdraw to see claims here"}
          </div>
          {!loggedIn && (
            <button
              type="button"
              ...
              style={{
                marginTop: 20,
                fontFamily: "'Fredoka', sans-serif", fontSize: 14, fontWeight: 800,
                background: "var(--cheap)", color: "#1a1000",
        ...
        <div>
          {readyClaims.length > 0 && (
            <>
              <div style={{ fontSize: 11, fontFamily: "'Fredoka', sans-serif", fontWeight: 800, color: "var(--cheap)", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 10 }}>
                Open — Waiting for moderator
              </div>
                    ...
                    <div key={claim._id} style={{ background: "var(--surface)", border: `1px solid ${accent}44`, borderRadius: "var(--radius)", padding: "14px 16px", position: "relative" }}>
                      ...
                      <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div style={{ fontFamily: "'Fredoka', sans-serif", fontWeight: 800, fontSize: 14, color: "var(--text)", marginBottom: 4, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                            {claim.itemName}
                          </div>
          ...
          {claimedClaims.length > 0 && (
            <>
              <div style={{ fontSize: 11, fontFamily: "'Fredoka', sans-serif", fontWeight: 800, color: "var(--text3)", textTransform: "uppercase", marginBottom: 10, marginTop: readyClaims.length ? 20 : 0 }}>
                Completed
              </div>
